...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item @yield('active_edit')">
        <a class="nav-link" href="{{route('edit')}}">
          <i class="fas fa-fw fa-edit"></i>
          <span>Edit Remindr</span>
        </a>
      </li>
      ...
      <li class="nav-item @yield('active_delete')">
        
        <a class="nav-link" href="{{route('delete')}}">
          <i class="fas fa-fw fa-recycle"></i>
          <span>Delete Remindr</span>
        </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <!-- <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60"> -->
                     <h6 class="d-none d-lg-inline"><sub><b>{{Auth::user()->email}}</b></sub></h6>
                </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; oLadIPO UmaR <?php echo(date('Y'));?></span>
          </div>
          <!-- <div class="copyright text-center my-auto">
            <span><i class="fas fa-facebook text-gray-400"></i></span>
          </div> -->
        </div>
      </footer>
      <!-- End of Footer -->
